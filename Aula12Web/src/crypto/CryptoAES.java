...
public class CryptoAES {
	...
	public void geraCifra(byte[] texto, File fSim)
			...
			InvalidAlgorithmParameterException, IOException, ClassNotFoundException,InvalidKeyException, java.security.InvalidKeyException{
	...
	public void geraDecifra(byte[] texto, File fSim)
			...
			IOException, ClassNotFoundException, java.security.InvalidKeyException {
